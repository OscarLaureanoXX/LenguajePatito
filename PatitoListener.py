...
class PatitoListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by PatitoParser#varz.
    def enterVarz(self, ctx:PatitoParser.VarzContext):
        pass

    # Exit a parse tree produced by PatitoParser#varz.
    def exitVarz(self, ctx:PatitoParser.VarzContext):
        pass


    # Enter a parse tree produced by PatitoParser#bloque.
    def enterBloque(self, ctx:PatitoParser.BloqueContext):
        pass

    # Exit a parse tree produced by PatitoParser#bloque.
    def exitBloque(self, ctx:PatitoParser.BloqueContext):
        pass
    ...
    # Enter a parse tree produced by PatitoParser#asignacion.
    def enterAsignacion(self, ctx:PatitoParser.AsignacionContext):
        pass

    # Exit a parse tree produced by PatitoParser#asignacion.
    def exitAsignacion(self, ctx:PatitoParser.AsignacionContext):
        pass
    ...
    # Enter a parse tree produced by PatitoParser#escritura.
    def enterEscritura(self, ctx:PatitoParser.EscrituraContext):
        pass

    # Exit a parse tree produced by PatitoParser#escritura.
    def exitEscritura(self, ctx:PatitoParser.EscrituraContext):
        pass
